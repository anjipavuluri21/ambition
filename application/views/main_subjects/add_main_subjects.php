                    ...
                    <div class="card card-primary">
                        ...
                        <form method="post" action="">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="exampleInputEmail1">Main Subject Name</label>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <button class="btn btn-primary" type="reset" ><a href="<?php echo base_url(); ?>main_subjects" style="color:white;">Cancel</a></button>
                            </div>
                        </form>
